...
public interface impListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link impParser#lvar}.
	 * @param ctx the parse tree
	 */
	void enterLvar(impParser.LvarContext ctx);
	/**
	 * Exit a parse tree produced by {@link impParser#lvar}.
	 * @param ctx the parse tree
	 */
	void exitLvar(impParser.LvarContext ctx);
	/**
